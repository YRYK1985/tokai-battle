...
export default function TokaiVote() {
  ...
  if (showRanking) {
    return (
      <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#1c1842,#1f1f46,#232346)", color: "#fff", fontFamily: "system-ui,sans-serif", padding: 0, margin: 0, paddingBottom: '80px', overflowX: "hidden", width: "100%" }}>
        ...
        <div style={{ maxWidth: "700px", margin: "0 auto 8px", padding: "12px 18px", background: "rgba(255,255,255,0.04)", borderRadius: "12px", lineHeight: "1.9" }}>
          <p style={{ color: "#888", fontSize: "12px", margin: 0 }}>
            「東海オンエア 動画バトル」は、東海オンエアの全{formatNum(FILTERED_VIDEOS.length)}本の動画をファン投票で順位付けするランキングサイトです。東海オンエアの公認切り抜きチャンネルである「東海ランキング」が運営しています。投票にはEloレーティングシステムを採用しており、2本の動画を比較する形式で「どっちが好き？」を繰り返すことで、統計的に信頼性の高い順位を算出しています。5回投票すると詳しいランキング結果を閲覧でき、全期間ランキングと年度別ランキングを切り替えて見ることができます。
          </p>
        </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg,#1a1640,#1e1e44,#222244)", color: "#fff", fontFamily: "system-ui,sans-serif", padding: 0, margin: 0, paddingBottom: '80px', display: "flex", flexDirection: "column", justifyContent: "flex-start", overflowX: "hidden", width: "100%" }}>
      ...
      <div style={{ padding: "0 16px 8px", maxWidth: "700px", margin: "0 auto", color: "#888", fontSize: "13px", lineHeight: "1.8" }}>
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "14px", padding: "18px 20px", marginBottom: "12px", border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <p style={{ margin: 0 }}>「東海オンエア 動画バトル」は、東海オンエアの全{FILTERED_VIDEOS.length.toLocaleString()}本の動画をファン投票で順位付けするランキングサイトです。東海オンエアの公認切り抜きチャンネルである「東海ランキング」が運営しています。投票にはEloレーティングシステムを採用しており、2本の動画を比較する形式で「どっちが好き？」を繰り返すことで、統計的に信頼性の高い順位を算出しています。5回投票すると詳しいランキング結果を閲覧でき、全期間ランキングと年度別ランキングを切り替えて見ることができます。</p>
        </div>
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "14px", padding: "18px 20px", marginBottom: "12px", border: "1px solid rgba(255,255,255,0.08)" }}>
          <p style={{ margin: "0 0 10px", fontWeight: 700, color: "#ddd", fontSize: "14px" }}>遊び方</p>
          <p style={{ margin: 0 }}>2本の動画が表示されたら「どっちの動画が好き？」を直感で選んでタップするだけ。特別な知識は必要ありません。5回投票すると詳しいランキング画面が解放され、全期間または年度別のランキングを確認できます。投票結果はXでシェアすることもできます。各動画のページでは詳細情報や関連動画も確認できます。</p>
        </div>
        <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: "14px", padding: "18px 20px", marginBottom: "12px", border: "1px solid rgba(255,255,255,0.08)" }}>
      ...
      {/* フッター */}
      <div style={{ padding: "16px 16px 100px", textAlign: "center", color: "#888", fontSize: "13px" }}>
        <a href="https://www.youtube.com/@tokairanking" target="_blank" rel="noopener noreferrer" style={{ color: "#888", textDecoration: "none" }}>東海ランキング【公認】チャンネルはこちら</a>
        <p style={{ margin: "12px 0 0" }}>
          <a href="/about" style={{ color: "#666", textDecoration: "none", fontSize: "12px" }}>このサイトについて</a>
          <span style={{ color: "#444", margin: "0 8px" }}>|</span>
          <a href="/privacy" style={{ color: "#666", textDecoration: "none", fontSize: "12px" }}>プライバシーポリシー</a>
        ...
        <p style={{ margin: "8px 0 0" }}>
          ...
          <span style={{ color: "#444", margin: "0 8px" }}>|</span>
          <a href="/analysis-2018" style={{ color: "#666", textDecoration: "none", fontSize: "12px" }}>2018年データ分析</a>
        </p>
      </div>
