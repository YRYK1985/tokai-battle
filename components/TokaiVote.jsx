        ...
        <div style={{ padding: "8px 16px 16px" }}>
          ...
          <div style={{ maxWidth: "700px", margin: "0 auto 24px", padding: "16px 18px", background: "rgba(255,255,255,0.04)", borderRadius: "12px", lineHeight: "1.9" }}>
            <p style={{ color: "#888", fontSize: "12px", margin: 0 }}>
              「東海オンエア 動画バトル」は、東海オンエアの全{formatNum(FILTERED_VIDEOS.length)}本の動画をファン投票で順位付けするランキングサイトです。運営は東海オンエアの公認切り抜きチャンネルである「東海ランキング」。投票にはEloレーティングシステムを採用しており、2本の動画を比較する形式で「どっちが好き？」を繰り返すことで、統計的に信頼性の高い順位を算出しています。5回投票すると全体のランキング結果を閲覧でき、全期間ランキングと年度別ランキングを切り替えて楽しめます。
            </p>
          </div>
